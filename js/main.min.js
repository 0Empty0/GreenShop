...
$(".slider__inner").slick({dots:!0,autoplay:!0,autoplaySpeed:3500,infinite:!0,speed:1100,slidesToShow:1,adaptiveHeight:!0,prevArrow:null,nextArrow:null}),$(".filter-bar__range-slider").ionRangeSlider({type:"double",min:0,max:1500,from:200,to:500,grid:!1,hide_min_max:!0,hide_from_to:!0});let priceBar=document.querySelector(".filter-bar__price-highlight");$(".filter-bar__range-slider").on("change",(function(){var e=$(this).data("from"),t=$(this).data("to");priceBar.innerHTML="$"+e+" - $"+t}));let popupMenu=document.querySelectorAll(".popup");function popup(){for(let e=0;e<passwordBar.length;e++)popupMenu[e].classList.remove("hide")}function popupClose(){for(let e=0;e<passwordBar.length;e++)popupMenu[e].classList.add("hide")}let login=document.querySelectorAll(".popup__login"),register=document.querySelectorAll(".popup__register");function loginMenu(){for(let e=0;e<login.length;e++)login[e].classList.remove("hide"),register[e].classList.add("hide")}function registerMenu(){for(let e=0;e<login.length;e++)login[e].classList.add("hide"),register[e].classList.remove("hide")}let passwordBar=document.querySelectorAll(".popup__input-password");function hide(){for(let e=0;e<passwordBar.length;e++){const t="password"===passwordBar[e].getAttribute("type")?"text":"password";passwordBar[e].setAttribute("type",t)}}let filterMenu=document.getElementById("filter-bar__wrapper");function filterShow(){const e="none"==window.getComputedStyle(filterMenu).getPropertyValue("display")?"flex":"none";filterMenu.style.display=e}let burgerMenu=document.querySelector(".burger-menu");function burgerMenuOpen(){burgerMenu.classList.toggle("hide")}$(".recomended-product__wrapper").slick({dots:!0,autoplay:!0,autoplaySpeed:6e3,speed:1500,slidesToShow:5,slidesToScroll:5,prevArrow:null,nextArrow:null,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3,dots:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:2,slidesToScroll:2}}]});
